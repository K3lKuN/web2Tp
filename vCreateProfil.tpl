...
<div class="col-md-10 well">
	...
	<form class="form-horizontal">
		...
		<div class="form-group">
			<label for="Diplome" class="col-xs-12 col-sm-12 col-md-2 ">Diplômes</label>
			<div class="col-xs-12 col-sm-4 com-md-4 col-lg-2">
				<textarea name="diplarea"></textarea>
			</div>
			<div class="col-sm-6 col-lg-8 col-xs-12 col-md-6">
				<select multiple>
